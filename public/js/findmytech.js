                    ...
                    angular.forEach($scope.techCompetency,function(techComp,key){
                        ...
                        if(techComp.techId == allTechs.id)
                        {
                            if(techComp.corecomp == "Fios")
                                icon = "/public/img/fiosTechie.png";
                            else
                                icon = "/public/img/TechieOnTheGo.png";
                        }
                    });
       ...
       // $scope.myproblem = "Please select your problem"; // red
        ...
        $scope.initTechMap = function() {
            ...
            if ($scope.techAtTheLocation)
                icoMarker1 = "/public/img/Busy.png";
            else
                icoMarker1 = "/public/img/Office_big.png";


            var icoMarker2;
            if ($scope.techAtTheLocation)
                icoMarker2 = "/public/img/Busy.png";
            else
            {
                if($scope.SelectedTech.joblocation.problem.jobComp == "Fios")
                    icoMarker2 = "/public/img/fios_Techie.png";
                else
                    icoMarker2 = "/public/img/TechieOnTheGo.png";
            }
